...
CORE_OBJS = ds4.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_expert_cache.o ds4_layer_pack.o ds4_engram.o $(MMQ_OBJS)
CPU_CORE_OBJS = ds4_cpu.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
...
ds4.o: ds4.c ds4.h ds4_ssd.h ds4_distributed.h ds4_gpu.h ds4_gpu_tp.h ds4_deepseek41_gpu.h ds4_linux_memory.h ds4_engram.h ds4_expert_cache.h
	$(CC) $(CFLAGS) -c -o $@ ds4.c

ds4_expert_cache.o: ds4_expert_cache.c ds4_expert_cache.h ds4_gpu.h
	$(CC) $(CFLAGS) -c -o $@ ds4_expert_cache.c
...
tests/ds4_expert_cache_test.o: tests/ds4_expert_cache_test.c ds4_gpu.h ds4_expert_cache.h
	$(CC) $(CFLAGS) -I. -c -o $@ tests/ds4_expert_cache_test.c

tests/ds4_expert_cache_test: tests/ds4_expert_cache_test.o ds4_cuda.o ds4_expert_cache.o ds4_image.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
